...
#include "modules/Telemetry/CO2Telemetry.h"
...
void setupModules()
{
    if (config.device.role != meshtastic_Config_DeviceConfig_Role_REPEATER) {
        ...
        // Añadir módulo de CO2 si hay sensores SCD30 disponibles
        if (nodeTelemetrySensorsMap[meshtastic_TelemetrySensorType_SCD4X].first > 0) {
            new CO2TelemetryModule();
        }
